...
import com.example.laboursapp.databinding.ActivityContractorSeeWorkBinding;
...
public class ContractorSeeWorkActivity extends AppCompatActivity {
    ActivityContractorSeeWorkBinding binding;
    private ContractorSeeWorkAdapter recyclerViewAdapter;
    private ArrayList<Work> workArrayList;
    private String id="";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityContractorSeeWorkBinding.inflate(getLayoutInflater());
    ...
    protected void onStart() {
        ...
        recyclerViewAdapter = new ContractorSeeWorkAdapter(ContractorSeeWorkActivity.this,
                workArrayList);
    ...
    private class ContractorSeeWork extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            try {
                String site_url_json = "http://10.0.2.2:8000/api/contractor_see_work/" + id;
